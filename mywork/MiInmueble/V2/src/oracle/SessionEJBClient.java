...
public class SessionEJBClient {
    public static void main(String [] args) {
        try {
            ...
            SessionEJB sessionEJB = (SessionEJB)context.lookup("MiInmueble-V2-SessionEJB#oracle.SessionEJB");
            for (Provincia provincia : (List<Provincia>)sessionEJB.getProvinciaFindAll()) {
                printProvincia(provincia);
            }
            for (Photos photos : (List<Photos>)sessionEJB.getPhotosFindAll()) {
                printPhotos(photos);
            }
    ...
    private static void printPhotos(Photos photos) {
        System.out.println( "image = " + photos.getImage() );
        System.out.println( "imageid = " + photos.getImageid() );
        System.out.println( "type = " + photos.getType() );
        System.out.println( "fotosList = " + photos.getFotosList() );
        System.out.println( "inmobiliariaList = " + photos.getInmobiliariaList() );
        System.out.println( "empresacorredoraList = " + photos.getEmpresacorredoraList() );
    }
    ...
    private static void printEmpresacorredora(Empresacorredora empresacorredora) {
        ...
        System.out.println( "photos = " + empresacorredora.getPhotos() );
    }
    ...
    private static void printInmobiliaria(Inmobiliaria inmobiliaria) {
        ...
        System.out.println( "photos = " + inmobiliaria.getPhotos() );
    ...
    private static void printFotos(Fotos fotos) {
        ...
        System.out.println( "photos = " + fotos.getPhotos() );
