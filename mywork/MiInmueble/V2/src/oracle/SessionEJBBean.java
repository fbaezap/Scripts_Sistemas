...
@Stateless(name = "SessionEJB", mappedName = "MiInmueble-V2-SessionEJB")
@Remote
@Local
public class SessionEJBBean implements SessionEJB, SessionEJBLocal {
    @PersistenceContext(unitName="V2")
    ...
    public Photos persistPhotos(Photos photos) {
        em.persist(photos);
        return photos;
    }

    public Photos mergePhotos(Photos photos) {
        return em.merge(photos);
    }

    public void removePhotos(Photos photos) {
        photos = em.find(Photos.class, photos.getImageid());
        em.remove(photos);
    }

    /** <code>select o from Photos o</code> */
    public List<Photos> getPhotosFindAll() {
