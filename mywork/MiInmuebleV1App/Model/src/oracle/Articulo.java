...
@NamedQueries({
  ...
  ,
  @NamedQuery(name = "Articulo.findByDestacada", query = "select o from Articulo o where o.destacada=:d")
})
public class Articulo implements Serializable {
    ...
    public Articulo(Long baños, String ciudad, String codiInterno, Long codigo,
                    Comuna comuna, String descripcion, String destacada,
                    String direccion, String estructura, Timestamp fecha,
                    String monto, Long piezas, Long pisos, String superficie,
