...
Insert into CORREDOR (VENDEDOR_RUT,NOMBRE,APELLIDOS,GENERO,EMPRESACORREDORA_RUT) values ('17742407-2','Sandra','Elgueta Brintrup','F',null);
...
Insert into PERSONA (VENDEDOR_RUT,NOMBRE,APELLIDOS,GENERO) values ('18409893-8','Francisco','Baeza Gallardo','M');